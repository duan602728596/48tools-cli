...
// 参数 config: 配置文件的配置项
// 参数 l: 正在直播的列表的item
func getLiveListAndDownloadOne(config cmdTypes.Config, l apiTypes.LiveListContentInfo) {
...
// 参数 config: 配置文件的配置项
func getLiveListAndDownload(config cmdTypes.Config) {
...
// LiveAuto 定时自动下载直播
// 参数 config: 配置文件的配置项
func LiveAuto(config cmdTypes.Config) {
